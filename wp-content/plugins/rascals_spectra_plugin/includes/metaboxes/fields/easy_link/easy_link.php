	...
	class MuttleyBox_easy_link extends MuttleyBox {
        ...
        */
		public function render() {
			...
			echo '<button class="_button easy-link"><i class="icon fa fa-external-link"></i>' . _x( 'Insert Link', 'MuttleyBox Class', $this->textdomain ) . '</button>';
		...
		private function widget() {
			...
			echo '<span>' . _x( 'Search', 'MuttleyBox Class', $this->textdomain ) . '</span>';
