 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
	    ...
	    public function __construct() {
	        ...
	        $this->required_plugins 	= apply_filters('radium_theme_importer_required_plugins', $this->required_plugins);
	    ...
	    public function add_admin() {
	        ...
	        $add_submenu_func( 'themes.php', "Demo Import", "Demo Import", 'switch_themes', 'demo_import', array($this, 'demo_installer'));
    	...
    	public function req_plugins_html() {
			...
			<div style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;">
			    <p class="tie_message_hint">Before you begin, you need to install and activate the following plugins (<a href="<?php echo site_url() ?>/wp-admin/themes.php?page=install-required-plugins">Install Plugins</a>):</p>
    		<ul style="padding-left: 20px;list-style-position: inside;list-style-type: square;}">
	  		<?php
