    ...
    class TGM_Plugin_Activation {
        ...
        protected function add_admin_menu( array $args ) {
            ...
            if ( 'themes.php' === $this->parent_slug ) {
                ...
                $add_page_func = 'add_' . 'submenu_' . 'page';
                $this->page_hook = call_user_func( $add_page_func, $args['parent_slug'], $args['page_title'], $args['menu_title'], $args['capability'], $args['menu_slug'], $args['function'] );
            }
        }
